        ...
        <div className="container" style={{ position: "relative", zIndex: 1 }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1.5fr", gap: "56px", alignItems: "start" }} className="form-layout">
            ...
            <form style={{ background: "#fff", borderRadius: "var(--radius-lg)", padding: "40px", display: "grid", gap: "20px", boxShadow: "0 24px 48px rgba(0,0,0,0.2)" }}>
              ...
              <button type="submit" style={{ background: "linear-gradient(180deg,#3a73d1,#2c5fb8)", color: "#fff", padding: "16px 32px", borderRadius: "var(--radius)", fontSize: "16px", fontWeight: 700, cursor: "pointer", boxShadow: "0 6px 18px rgba(44,95,184,0.35)", border: "none" }}>
                送信する
              </button>
