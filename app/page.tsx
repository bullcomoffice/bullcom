        ...
        <div style={{
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            <div style={{ display: "flex", gap: "12px", flexWrap: "wrap", marginBottom: "32px" }}>
              <a href="tel:0789122656" data-tel-loc="top-hero" className="btn btn-primary" style={{ padding: "16px 28px", fontSize: "16px" }}>
              ...
              {/* リモートDL。電話中のお客様に「ホームページの上のリモートDL」と言えば
                  辿り着けるよう、ヒーローに置いている。対象はご購入者・年間契約者のみ。
                  リンク先を /remote ではなく短縮URL /r にしているのは、電話で伝える
                  URLと同じ入口に揃えるため。行き先を変えるときは Worker の1箇所で済む。 */}
              <a
              ...
              >
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <path d="M12 6v5" /><polyline points="9.5 8.5 12 11 14.5 8.5" />
                </svg>
                リモートDL
              </a>
            </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1.4fr", gap: "56px", alignItems: "start" }} className="contact-layout">
            ...
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                {/* 電話 */}
                <a href="tel:0789122656" data-tel-loc="top-cta" style={{ display: "flex", alignItems: "center", gap: "16px", background: "rgba(255,255,255,0.1)", border: "1px solid rgba(255,255,255,0.2)", borderRadius: "var(--radius-lg)", padding: "20px 24px", textDecoration: "none", transition: "background 0.15s" }}>
